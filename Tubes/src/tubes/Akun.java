...
import Kurir.KurirAntar;
import Pengirim.MenuPengirim;
...
public class Akun extends javax.swing.JFrame {
    ...
    MenuPengirim send = new MenuPengirim();
    MenuAdmin ad = new MenuAdmin();
    KurirAntar anter = new KurirAntar();
    ...
    private void initComponents() {
        ...
        jDialog1.setSize(new java.awt.Dimension(320, 100));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String uname, pass, role = null;
        boolean confirm = false;
        
        uname = jTextField1.getText();
        pass = String.valueOf(jPasswordField1.getPassword());
        for(int i=0; i < dbcon.getUsr().length; i++){
            if(uname.equals(dbcon.getUsr()[i]) && pass.equals(dbcon.getPwd()[i])){
                confirm = true;
                role = dbcon.getRole()[i];
            }
        }
        if(confirm){
            ...
            } else if ("kurir".equals(role)) {
                anter.setVisible(true);
                this.setVisible(false);
            ...
            jLabel3.setText("Error! Masukkan username dan password");
        }
